...
{{-- 
    ...
    <div class="dropdown text-center">
        ...
        <ul class="dropdown-menu dropdown-menu-end" style="">
            <li><button class="dropdown-item" onclick="editForm( '{{route('admin.offer.view',$item->id)}}','modal_body')" data-bs-target="#view_modal" data-bs-toggle="modal">View</button></li>
            <li><button class="dropdown-item"  onclick="editForm( '{{route('admin.offer.edit',$item->id)}}','edit_modal_body')" data-bs-target="#edit_modal" data-bs-toggle="modal">Edit</button></li>
        </ul>
    </div>